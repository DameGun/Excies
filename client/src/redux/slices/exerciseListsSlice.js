  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: getExerciseLists, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
...
export const thunkCreateExerciseList = createAsyncThunk(
  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: createExerciseList, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
...
export const thunkUpdateExerciseList = createAsyncThunk(
  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: updateExerciseList, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
...
export const thunkDeleteExerciseList = createAsyncThunk(
  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: deleteExerciseList, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
