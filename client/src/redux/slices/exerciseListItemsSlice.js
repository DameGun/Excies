  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: getExerciseListItems, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
...
export const thunkCreateExerciseListItem = createAsyncThunk(
  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: createExerciseListItem, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
...
export const thunkDeleteExerciseListItem = createAsyncThunk(
  ...
  async (params, { dispatch, rejectWithValue }) => {
    try {
      const response = await thunkHandler(
        { apicall: deleteExerciseListItem, payload: params.payload },
        { dispatch }
      );
      return response;
    } catch (err) {
